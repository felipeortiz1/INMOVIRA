                ...
                <div class="card border-0 shadow-sm rounded-4 overflow-hidden bg-white">
                    ...
                    <div class="card-header bg-gradient-dark text-white p-4 border-0">
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <div>
                                <h4 class="mb-1 fw-bold text-white">Crear Nuevo Tipo de Inmueble</h4>
                                <p class="mb-0 text-white-50 fs-7">Registra una nueva categoría de propiedad en el sistema</p>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text"
                                        ...
                                        id="nombre" name="nombre" placeholder="Ej: Casa, Apartamento, Local..." value="{{ old('nombre') }}">
                                </div>
                                @error('nombre')
