                ...
                <div class="card border-0 shadow-sm rounded-4 overflow-hidden bg-white">
                    ...
                    <div class="card-header bg-gradient-dark text-white p-4 border-0">
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <div>
                                <h4 class="mb-1 fw-bold text-white">Editar Tipo de Inmueble</h4>
                                <p class="mb-0 text-white-50 fs-7">Actualiza el nombre de la categoría de propiedad</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body p-4 p-md-5">
                        ...
                        <form action="{{ route('tipoInmueble.update', $tipoInmueble->id) }}" method="POST" class="needs-validation" novalidate>
                            @csrf
                            {{-- Campo Tipo de Inmueble --}}
                            <div class="mb-4">
                                <label for="nombre" class="form-label text-muted small fw-semibold">Tipo de inmueble</label>
                                <div class="input-group">
                                    ...
                                    <input type="text"
                                        ...
                                        id="nombre" name="nombre" value="{{ old('nombre', $tipoInmueble->nombre) }}"
