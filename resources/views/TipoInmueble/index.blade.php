...
<div class="container mt-4 animate-fade">
    <div class="card border-0 shadow-lg rounded-4">
        <div class="card-header bg-gradient text-white rounded-top-4" 
            ...
            <h5 class="mb-0 fw-bold"><i class="fas fa-building"></i> Lista de Tipos de Inmuebles</h5>
        </div>
        ...
        <div class="card-body p-4">
            ...
            <div class="d-flex justify-content-between align-items-center mb-3">
                <a href="{{ route('tipoInmueble.create') }}" 
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <form action="{{ route('tipoInmueble.destroy', $tipoInmueble->id) }}" 
