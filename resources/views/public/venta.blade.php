...
<head>
    ...
    <title>Inmuebles en Venta | Premium</title>
    ...
    <style>
        ...
        :root {
            ...
            --text-main: #1E293B;
            --text-muted: #64748B;
            --accent: #3B82F6; /* Un tono azul/celeste vibrante para diferenciar VENTA de ARRIENDO */
            --accent-hover: #2563EB;
        ...
        * {
        ...
        .nav .left a {
            color: #064E3B; /* Verde muy oscuro para contraste */
...
<nav class="nav">
    <div class="left">
        ...
        <a href="{{ route('vista.venta') }}" class="active"><i class="fa-solid fa-tag"></i> Venta</a>
...
<div class="container">
    <div class="page-header">
        <h1>Oportunidades de <span>Venta</span></h1>
        <p style="color: var(--text-muted); font-size: 1.1rem; margin-top: 8px;">Invierte en tu futuro con las mejores propiedades del mercado.</p>
    </div>
            ...
            <form id="filterForm" method="GET" class="filters" action="{{ route('vista.venta') }}">
                ...
                <div class="filter-group">
                    ...
                    <div class="input-wrapper">
                        ...
                        <input type="search" name="q" placeholder="Ej. Lote esquinero..." value="{{ request('q') }}">
                    </div>
                </div>
                ...
                <div class="filter-actions">
                    ...
                    <a href="{{ route('vista.venta') }}" class="btn btn-ghost"><i class="fa-solid fa-rotate-right"></i> Limpiar</a>
                </div>
            </form>
        </aside>
        ...
        <main style="flex: 1;">
            @if($inmuebles->isEmpty())
                <div class="empty">
                    ...
                    <a href="{{ route('vista.venta') }}" class="btn btn-primary" style="margin-top: 16px;">Ver todo el catálogo</a>
                </div>
            @else
                    ...
                    @foreach($inmuebles as $item)
                        ...
                        <article class="card">
                            <div class="card-img-wrapper">
                                ...
                                <span class="badge-type">{{ $item->tipo ?? 'Venta' }}</span>
